...
def test_load_data_ports_not_existing(caplog):
    ...
    try:
        ...
        testing_utils.shutdown_environment_only_core(caplog=caplog, expected_warnings=0, expected_errors=4)
...
def test_load_wrong_data_types(caplog):
    ...
    try:
        ...
        testing_utils.shutdown_environment_only_core(caplog=caplog, expected_warnings=0, expected_errors=8)
