...
def check_pane_positions():
    ...
    for config_id, pan_id in list(constants.PANE_ID.items()):
    ...
    for config_id, pane_id in list(constants.PANE_ID.items()):
...
def test_window_positions(caplog):
    ...
    try:
        ...
        for key, value in list(original_runtime_config.items()):
