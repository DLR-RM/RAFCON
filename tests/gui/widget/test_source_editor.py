...
def test_gui(caplog):
    ...
    testing_utils.initialize_environment(gui_config={'GAPHAS_EDITOR': True,
    ...
    testing_utils.shutdown_environment(caplog=caplog, expected_warnings=0, expected_errors=errors, unpatch_threading=False)
