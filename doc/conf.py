...
exclude_patterns = ['.build', 'assets', '**/includes']
...
latex_documents = [
  ('index', 'RAFCON.tex', u'RAFCON API',
   u'Sebastian Brunner, Franz Steinmetz, Rico Belder', 'manual'),
]
...
man_pages = [
    ('index', 'RAFCON API', u'RAFCON API',
     ['Sebastian Brunner', 'Franz Steinmetz', 'Rico Belder'], 1)
]
...
texinfo_documents = [
  ('index', 'RAFCON API', u'RAFCON API', u'Sebastian Brunner, Franz Steinmetz, Rico Belder',
...
pdf_documents = [
    ('index', u'RAFCON API', u'RAFCON API', u'Sebastian Brunner, Franz Steinmetz, Rico Belder'),
]
