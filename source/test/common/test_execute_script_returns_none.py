...
def test_execute_script_returns_none(caplog):
    ...
    [state_machine, version, creation_time] = rafcon.statemachine.singleton.\
        global_storage.load_statemachine_from_path(utils.get_test_sm_path("return_none_test_sm"))
    ...
    utils.sm_manager_model.get_selected_state_machine_model().root_state.load_meta_data()
