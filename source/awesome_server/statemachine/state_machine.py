...
from awesome_server.statemachine.id_generator import generate_state_machine_id
from awesome_server.utils import log
logger = log.get_logger(__name__)
from awesome_server.statemachine.execution.execution_history import ExecutionHistory
...
class StateMachine(Observable):
    ...
    def wait_for_finishing(state):
        ...
        from awesome_server.statemachine.singleton import state_machine_execution_engine
