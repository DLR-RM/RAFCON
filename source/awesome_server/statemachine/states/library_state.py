...
from awesome_server.statemachine.enums import StateExecutionState
...
class LibraryState(State, yaml.YAMLObject):
    ...
    def __init__(self, library_path=None, library_name=None, version=None,  # library state specific attributes
        ...
        lib_os_path, new_library_path, new_library_name = \
            awesome_server.statemachine.singleton.library_manager.get_os_path_to_library(library_path, library_name)
        ...
        state_machine, lib_version, creation_time = awesome_server.statemachine.singleton.library_manager.storage.\
