...
from awesome_server.statemachine.enums import DataPortType, StateExecutionState
from awesome_server.statemachine.script import Script, ScriptType
from awesome_server.statemachine.states.state import State
from awesome_server.statemachine.transition import Transition
from awesome_server.statemachine.outcome import Outcome
from awesome_server.statemachine.data_flow import DataFlow
from awesome_server.statemachine.scope import ScopedData, ScopedVariable
from awesome_server.statemachine.id_generator import *
from awesome_server.statemachine.config import *
from awesome_server.statemachine.validity_check.validity_checker import ValidityChecker
import awesome_server.statemachine.singleton
...
class ContainerState(State):
    ...
    def handle_no_transition(self, state):
        ...
        while not transition:
            ...
            execution_signal = awesome_server.statemachine.singleton.state_machine_execution_engine.handle_execution_mode(self)
    ...
    def add_state(self, state):
        ...
        own_sm_id = awesome_server.statemachine.singleton.state_machine_manager.get_sm_id_for_state(self)
        if own_sm_id is not None:
            awesome_server.statemachine.singleton.global_storage.unmark_path_for_removal_for_sm_id(
    ...
    def remove_state(self, state_id, recursive_deletion=True):
        ...
        if own_sm_id is None:
            ...
            awesome_server.statemachine.singleton.global_storage.mark_path_for_removal_for_sm_id(own_sm_id,
    ...
    def add_transition(self, from_state_id, from_outcome, to_state_id=None, to_outcome=None, transition_id=None):
        ...
        from awesome_server.statemachine.states.concurrency_state import ConcurrencyState
