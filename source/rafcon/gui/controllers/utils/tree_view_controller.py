...
class AbstractTreeViewController(ExtendedController):
    ...
    def destroy(self):
        ...
        # print "disconnect in", self.__class__.__name__, self.handler_ids
    ...
    def register_view(self, view):
        ...
        self.handler_ids.append((self._tree_selection, self._tree_selection.connect('changed', self.selection_changed)))
        # self.handler_ids.append((self.tree_view, self.tree_view.connect('key-press-event', self.tree_view_keypress_callback)))
