...
class StateDataFlowsListView(TreeView):
    def __init__(self):
        super().__init__(builder=glade.get_glade_path('data_flow_list_widget.glade'), parent='tree_view')
        self.tree_view = self['tree_view']


class StateDataFlowsEditorView(View):
    def __init__(self):
        super().__init__(builder=glade.get_glade_path('state_data_flows_widget.glade'), parent='data_flows_container')
