...
class Clipboard(Observable):
    ...
    def paste(self, target_state_m, cursor_position=None, limited=None, convert=False):
        ...
        def insert_elements_from_model_copies_list(model_list, element_str):
            ...
            :param element_str: appendix string to "_insert_*" to get the attribute of respective methods in
                                clipboard-class.
            ...
            for orig_element_m_copy in model_list:
                try:
                    ...
                    new_element_m = getattr(self, '_insert_{0}'.format(element_str))(target_state_m, orig_element_m_copy)
        ...
        for elements_list in insert_dict.itervalues():
            affected_models.extend([elem[0] for elem in elements_list])
