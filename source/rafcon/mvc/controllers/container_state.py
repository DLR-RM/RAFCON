...
from rafcon.mvc.controllers.state_transitions import StateTransitionsListController
from rafcon.mvc.controllers.state_data_flows import StateDataFlowsListController
...
class ContainerStateController(ExtendedController):
    ...
    :param rafcon.mvc.views.StatePropertiesView view: The GTK view showing the data as a table
    """
    ...
    #
    #     :param rafcon.mvc.models.StateModel model: The model of the state being handled by the controller
