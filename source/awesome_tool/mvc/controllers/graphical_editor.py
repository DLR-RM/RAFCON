...
class GraphicalEditorController(ExtendedController):
    ...
    def _create_new_transition(self, to_state_m, to_outcome_id=None):
        ...
        :param awesome_tool.mvc.models.state.StateModel to_state_m: The to state model of the new transition
    ...
    def _create_new_data_flow(self, target_port_m):
        ...
        :param awesome_tool.mvc.models.data_port.DataPortModel target_port_m: The target port of the data flow
        """
    ...
    def _resize_state(self, state_m, new_corner_pos, keep_ratio=False, resize_content=False):
        ...
        if state_m.parent is not None:
            max_right_edge = state_m.parent.temp['gui']['editor']['pos'][0] + \
                             state_m.parent.meta['gui']['editor_opengl']['size'][0]
            min_bottom_edge = state_m.parent.temp['gui']['editor']['pos'][1] - \
                              state_m.parent.meta['gui']['editor_opengl']['size'][1]
    ...
    def draw_inner_data_ports(self, parent_state_m, parent_depth):
        ...
        :param awesome_tool.mvc.models.container_state.ContainerStateModel parent_state_m: The parent state model of
            the ports
    ...
    def _handle_new_transition(self, parent_state_m, parent_depth):
        ...
        :param awesome_tool.mvc.models.container_state.ContainerStateModel parent_state_m: Model of the container state
    ...
    def _selection_ids_to_model(self, ids, search_state, search_state_depth, selection, selection_depth, all=False,
        ...
        :param awesome_tool.mvc.models.state.StateModel search_state: The state to search in
